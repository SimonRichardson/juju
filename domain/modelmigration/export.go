...
func (e *Exporter) ExportOperations(registry corestorage.ModelStorageRegistryGetter) {
	blockcommand.RegisterExport(e.coordinator, e.logger)
	modelconfig.RegisterExport(e.coordinator)
	access.RegisterExport(e.coordinator, e.logger)
	keymanager.RegisterExport(e.coordinator)
	credential.RegisterExport(e.coordinator, e.logger)
	network.RegisterExport(e.coordinator, e.logger)
	externalcontroller.RegisterExport(e.coordinator)
	machine.RegisterExport(e.coordinator, e.clock, e.logger)
	blockdevice.RegisterExport(e.coordinator, e.logger)
	storage.RegisterExport(e.coordinator, registry, e.logger)
	secret.RegisterExport(e.coordinator, e.logger)
	application.RegisterExport(e.coordinator, e.storageRegistryGetter, e.clock, e.logger)
	status.RegisterExport(e.coordinator, e.clock, e.logger)
	resource.RegisterExport(e.coordinator, e.clock, e.logger)
	cloudimagemetadata.RegisterExport(e.coordinator, e.logger, e.clock)
	model.RegisterExport(e.coordinator, e.logger)
