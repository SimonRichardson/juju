...
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/interface_mock.go github.com/juju/juju/internal/worker/uniter/shared/operation Operation,Factory,Callbacks
