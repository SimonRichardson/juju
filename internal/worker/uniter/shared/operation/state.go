...
//
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/uniterstaterw_mock.go github.com/juju/juju/internal/worker/uniter/shared/operation UnitStateReadWriter
