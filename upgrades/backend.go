...
type StateBackend interface {
	...
	AddDefaultArchitectureToModelConfig() error
}
...
func (s stateBackend) AddDefaultArchitectureToModelConfig() error {
	return state.AddDefaultArchitectureToModelConfig(s.pool)
}
