...
func (c *Client) GetCharmURLOrigin(ctx context.Context, branchName, applicationName string) (*charm.URL, apicharm.Origin, error) {
...
// returned.
func (c *Client) GetConfig(ctx context.Context, branchName string, appNames ...string) ([]map[string]interface{}, error) {
...
func (c *Client) SetCharm(ctx context.Context, branchName string, cfg SetCharmConfig) error {
...
func (c *Client) UpdateApplicationBase(ctx context.Context, appName string, base corebase.Base, force bool) error {
	...
	if err := c.facade.FacadeCall(ctx, "UpdateApplicationBase", args, results); err != nil {
		return errors.Trace(err)
	}
...
func (c *Client) Get(ctx context.Context, branchName, application string) (*params.ApplicationGetResults, error) {
...
func (c *Client) SetConfig(ctx context.Context, branchName, application, configYAML string, config map[string]string) error {
...
func (c *Client) UnsetApplicationConfig(ctx context.Context, branchName, application string, options []string) error {
