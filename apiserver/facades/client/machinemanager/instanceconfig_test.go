...
func (s *machineConfigSuite) TestMachineConfig(c *gc.C) {
	...
	icfg, err := machinemanager.InstanceConfig(context.Background(), s.controllerConfigService, s.ctrlSt, s.st, s.cloudService, s.credService, s.objectStoreFactory, "0", "nonce", "")
