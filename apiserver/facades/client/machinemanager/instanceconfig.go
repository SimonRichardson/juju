...
func InstanceConfig(ctrlSt ControllerBackend, st InstanceConfigBackend, machineId, nonce, dataDir string, cc ControllerConfigGetter) (*instancecfg.InstanceConfig, error) {
	model, err := st.Model()
	if err != nil {
