...
type ModelManagerBackend interface {
	...
	ComposeNewModelConfig(configSchemaSourceGetter config.ConfigSchemaSourceGetter, modelAttr map[string]interface{}, regionSpec *environscloudspec.CloudRegionSpec) (map[string]interface{}, error)
