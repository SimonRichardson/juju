...
func TestingAPIHandler(c *gc.C, pool *state.StatePool, st *state.State, cc stateauthenticator.ControllerConfigGetter) (*apiHandler, *common.Resources) {
	authenticator, err := stateauthenticator.NewAuthenticator(pool, clock.WallClock, cc)
...
// entity.
func TestingAPIHandlerWithEntity(c *gc.C, pool *state.StatePool, st *state.State, entity state.Entity, cc stateauthenticator.ControllerConfigGetter) (*apiHandler, *common.Resources) {
	h, hr := TestingAPIHandler(c, pool, st, cc)
