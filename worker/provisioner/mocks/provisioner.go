...
// Source: github.com/juju/juju/worker/provisioner (interfaces: ContainerMachine,ContainerMachineGetter,ContainerProvisionerAPI,ControllerAPI,MachinesAPI,ControllerConfigGetter)
