...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/domain_mock.go github.com/juju/juju/worker/certupdater ControllerConfigGetter
