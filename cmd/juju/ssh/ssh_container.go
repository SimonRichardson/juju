...
func (c *sshContainer) maybePopulateTargetViaField(_ context.Context, _ *resolvedTarget, _ func(context.Context, *client.StatusArgs) (*params.FullStatus, error)) error {
	return nil
}
